    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                # ✅ deletion.CASCASDEではなくmodels.CASCADEでOK
                ('user', models.ForeignKey(on_delete=models.CASCADE, to='accounts.account', verbose_name='ユーザーID')),
        ...
        # 他のCreateModelも同様に models.CASCADE に統一
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='作成日時')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='更新日時')),
                ('checklist', models.ForeignKey(on_delete=models.CASCADE, related_name='items', to='codemon.checklist', verbose_name='チェックリストID')),
            ],
            options={
