    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "blockly_xml",
                    models.TextField(blank=True, null=True, verbose_name="Blockly XML"),
                ),
                (
                    "created_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "element_type",
                    models.CharField(max_length=50, verbose_name="要素タイプ"),
                ),
                (
                    "element_label",
                    models.CharField(
                        blank=True, max_length=200, null=True, verbose_name="要素ラベル"
                    ),
                ),
                (
                    "element_value",
                    models.TextField(blank=True, null=True, verbose_name="要素値"),
                ),
                ...
                (
                    "style_data",
                    models.JSONField(
                        blank=True, null=True, verbose_name="スタイルデータ"
                    ),
                ),
                (
                    "element_config",
                    models.JSONField(blank=True, null=True, verbose_name="要素設定"),
                ),
                ("sort_order", models.IntegerField(default=0, verbose_name="表示順")),
                (
                    "created_at",
